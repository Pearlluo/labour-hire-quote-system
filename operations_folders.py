...
Path: Operations/01 Marlu Contracts/{ProjectFolder}/{JobFolder}/00 Commercial (Secured)/01 Client Quotes
"""
...
def _drive_rel_path(sharepoint_url: str) -> str:
    ...
    Direct:  ".../sites/IMS/Operations/01 Marlu Contracts/..." → "01 Marlu Contracts/..."
    Forms:   ".../Operations/Forms/...aspx?id=%2F...Operations%2F01%20Marlu..." → same
    """
...
def get_contract_folder_url(token: str, client_business_name: str) -> Dict[str, str]:
    """Return {name, url} of the contract folder under 01 Marlu Contracts
